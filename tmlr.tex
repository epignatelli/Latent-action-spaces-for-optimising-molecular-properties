...
These models -- whether autoregressive~\citep{?}, diffusion-based \citep{vignac2023midi,cornet2024equivariant}, or flow-matching~\citep{dunn_mixed_2024} -- are trained to fit a data distribution: to generate molecules that look like those in a dataset.
