...
Beyond competitive performance, a learned action space is a gateway to interpretability and discovery.
...
Learning, using and inspecting new latent codes may thus open the door to discovering new ways of assembling molecules.
